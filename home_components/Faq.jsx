  ...
  return (
    <section className="relative base:mt-[12.5rem] flex flex-col items-center base:top-0 -top-[14.75rem]">
      ...
      <div className="mt-20 h-fit base:px-[18.31rem] px-4">
          ...
          <div key={index} className="">
            <article
              className={`base:py-10 py-8 base:px-12 px-8 flex items-start gap-6 border ${
                openIndex === index
                  ? "border-purple_900 base:rounded-[1.25rem] rounded-[1rem]"
                  : "border-transparent"
            ...
            >
              <div className="relative top-[0.125rem] w-[1.9rem] h-[1.9rem] flex-shrink-0 ">
                <Image
                  ...
                  height={30}
                  className={`absolute ${
                    openIndex === index ? "show-answer" : "hide-answer"
                  }`}
                />
                <Image
              ...
              <div>
                ...
                >
                  <p
                    ...
                    className={`${
                      openIndex === index ? "top-0 opacity-100" : "-top-[2rem] opacity-0"
            ...
            <div
              className={`${
                index === faqs.length - 1
                  ? ""
                  : "base:border-t-[0.1rem] border-t-[0.095rem] border-dashed border-black_400"
              }`}
            ></div>
          </div>
        ))}
        ...
        {/* view more button */}
        <div className="w-fit base:pl-12 pl-8 mt-12" onClick={handleViewMore}>
          <Button
            text={showAll ? "Show less FAQs" : "View more FAQs"}
